...
//////////////////////////////////////////////////////////////////////
//
// SerialBusEx - Win32 message-based wrapper for serial communications
//
...
namespace usbcom
{
   class SerialBusEx : public SerialBus
   {
      // Construction
   public:
      SerialBusEx();
   ...
   protected:
      ...
      using SerialBus::GetEventType;
      using SerialBus::GetError;
