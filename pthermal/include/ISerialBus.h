...
//////////////////////////////////////////////////////////////////////
//
// ISerialBus - Win32 wrapper for serial communications
//
...
namespace usbcom
{
   ...
   public:
      ...
      virtual ~ISerialBus ( ) {}
      //Enumeration
      virtual void EnumerateWin32Ports ( ) = 0;
   ...
   public:
      ...
      virtual LONG Open ( LPCTSTR lpszDevice, DWORD dwInQueue = 0, DWORD dwOutQueue = 0, bool fOverlapped = SERIAL_DEFAULT_OVERLAPPED ) = 0;
      ...
      virtual LONG Write ( const void* pData, size_t iLen, DWORD* pdwWritten = 0, LPOVERLAPPED lpOverlapped = 0, DWORD dwTimeout = INFINITE ) = 0;
      virtual LONG Write ( LPCSTR pString, DWORD* pdwWritten = 0, LPOVERLAPPED lpOverlapped = 0, DWORD dwTimeout = INFINITE ) = 0;
      ...
      virtual LONG GetLastError ( void ) const = 0;
...
#endif
      int m_nPorts;
      std::string m_DeviceType;  ///\< \brief Name of the device on the other end of the serial connection.
      //std::vector <ofSerialDeviceInfo> m_devices;  ///\< This vector stores information about all serial devices found.
      bool m_bHaveEnumeratedDevices;  ///\< \brief Indicate having enumerated devices (serial ports) available.
      bool m_bInited;  ///\< \brief Indicate the successful initialization of the serial connection.
      std::shared_ptr<std::vector<std::ustring>> m_acPortNamesFriendly;
   protected:
      // Check the requirements
      virtual void CheckRequirements ( LPOVERLAPPED lpOverlapped, DWORD dwTimeout ) const = 0;

      // CancelIo wrapper (for Win95 compatibility)
      virtual BOOL CancelCommIo ( void ) = 0;
   };
};